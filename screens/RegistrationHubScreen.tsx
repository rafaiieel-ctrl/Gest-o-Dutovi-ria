...
import { Location, LocationType, SimpleAsset, SimpleAssetType, Vessel, EquipmentType } from '../types';
                     ...
                     <div className="flex flex-wrap gap-4 justify-between items-center mb-4">
                        ...
                        <div className="flex w-full sm:w-auto items-center gap-2 flex-wrap justify-end">
                            ...
                            <div className="flex gap-2 flex-shrink-0">
                                <Button variant="secondary" onClick={() => navigate('/registration-hub/bulk-edit')} size="sm">Importar em Lote (TXT)</Button>
