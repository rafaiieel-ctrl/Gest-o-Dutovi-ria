...
const BASES_ORIGEM = [
    'Logum Paulínia (L003)',
    'Logum Ribeirão Preto (L004)',
    'Logum Barueri (L005)',
    'Logum Uberaba (L006)',
    'Logum Duque de Caxias (L007)',
    'Logum Volta Redonda (L011)',
    'Logum Guarulhos (L012)',
    'Logum SJC - Raizen (X010)',
    'Logum SCS - Raizen (X012)',
    'Logum SJC - BAVAP/Vibra (Y010)',
    'Logum SCS - Ipiranga (Y012)',
    'Logum SCS - BR (Z012)'
];
...
export const generateDutoviarioSchedules = (count: number): DutoviarioSchedule[] => {
    ...
    for (let i = 1; i <= count; i++) {
        schedules.push({
            ...
            base_origem: getRandom(BASES_ORIGEM),
            base_destino: getRandom(BASES_ORIGEM),
            ...
            produto: getRandom(productTypes),
            tipo_operacao: getRandom(['venda_tanque', 'transferencia', 'transferencia_destino', 'transferencia_propriedade']),
